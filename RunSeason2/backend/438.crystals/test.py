def get_character_blocks(s):
    """Get the list of characters and their consecutive counts in the string."""
    if not s:
        return [], []
...
def min_transformations(s1, s2, s3):
    ...
    for i in range(len(chars1)):
        ...
        # Выбираем целевое количество символов в блоке как медиану
...
result = min_transformations(s1, s2, s3)
print(result)
